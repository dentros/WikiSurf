...
def scrapWiki(search_word, search_modeFlag, target_word, printing):
    ...
    try:
        ...
        #print("\tscrapped Sites:", scrappedSites)
...
##########################################################################
#            Nikos Papadopoulos: github.com/dentros                      #
##########################################################################
...
try:
	...
	print("jumped this because there was an exception in scrapWiki function! You are unlucky to have this in the 1st page you scrap!!!")
while (i<population):
    ...
    GAPcounter-=1
    i+=1
    print("\t#No of article:",i,"#\t",GAPcounter," more until the next Freq", "#\t#this link appeared only ",linkFreqInAllLinks-1, "time(s) in the AllList" )
    ...
    if (GAPcounter==0):
        try:
            ...
            print("jumped this because of expetion on scrapWiki function")
